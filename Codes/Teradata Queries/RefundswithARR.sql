...
ARR.Refund_Wt_SG,
ARR.Refund_Qty_SG,
ARR.Scanned_Sales_Qty_SG,
ARR.Scanned_Sales_Value_SG,
ARR.Scanned_Sales_Wgt_SG
...
Scanned_Sales_Wgt ,
GrossSales,
((zeroifnull(Change_of_Mind)*1000000)/GrossSales) as Change_Of_Mind_RPMU,
((zeroifnull(GHS_Refund)*1000000)/GrossSales) as GHS_Refund_RPMU,
((zeroifnull(Product_Quality)*1000000)/GrossSales) as Product_Quality_RPMU,
((zeroifnull(EPW_Recall)*1000000)/GrossSales) as EPW_Recall_RPMU
...
on onlyreturn.Product_Sub_Group_Code=ARR.Product_Sub_Group_Code
