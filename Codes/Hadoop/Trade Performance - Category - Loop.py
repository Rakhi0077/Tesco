...
for val in weekList:
	...
	groupList = [
	"business_area","commercial_area","category_area","store_format_description", "channel" ,"country_code" ,"year_week_number"
	]
	...
	histIp = sqlContext.sql("select * from lab_rcoe.tradeperformance_category"
	...
	sqlContext.sql("insert overwrite table lab_rcoe.tradeperformance_category partition(country_code,year_week_number) select * from finalTbl")
