...
for val in weekList:
	...
	groupList = [
	"business_area","commercial_area","store_format_description", "channel" ,"country_code" ,"year_week_number"
	]
	...
	histIp = sqlContext.sql("select * from lab_rcoe.tradeperformance_commercial"
	...
	sqlContext.sql("insert overwrite table lab_rcoe.tradeperformance_commercial partition(country_code,year_week_number) select * from finalTbl")
