<?php
	...
	if (isset($_GET['userId']) && isset($_GET['geography']) && isset($_GET['QVIS']) && isset($_GET['rating']) && isset($_GET['overallrating']) && isset($_GET['category']) && isset($_GET['JuniorBuyer']) && isset($_GET['tesco_brand_ind'])){
		...
		*/
		...
		$req_columns="B.Parent_Supplier_Name as Parent_Supplier_Name,B.Parent_Supplier_Number_TFMS,A.Supplier_Number,B.Supplier_Name,A.Commercial_Area,A.Category_Area,A.Junior_Area,A.Own_Brand_Lines_Count,A.Brand_Lines_Count,Quality_Rank,Value_Rank,Innovation_Rank,Supply_Rank,QVIS_Rank";
		...
		if ($QVIS=="All" AND $rating=="All")
			$query="SELECT DISTINCT $req_columns FROM View_Rank_QVIS_Junior_Buyer AS A INNER JOIN Suppliers_List AS B ON A.Supplier_Number=B.Supplier_Number AND A.Category_Area=B.Category_Area AND A.Junior_Area=B.Junior_Area WHERE $sub_query_2 AND $sub_query_3 AND $sub_query_4 AND $sub_query_5 AND $sub_query_6 AND $sub_query_7 ORDER BY A.Junior_Area,QVIS_Rank DESC,Supplier_Name;";
			
		if ($QVIS=="All" AND $rating!="All")
			$query="SELECT DISTINCT $req_columns FROM View_Rank_QVIS_Junior_Buyer AS A INNER JOIN Suppliers_List AS B ON A.Supplier_Number=B.Supplier_Number AND A.Category_Area=B.Category_Area AND A.Junior_Area=B.Junior_Area WHERE $sub_query_2 AND $sub_query_3 AND $sub_query_4 AND $sub_query_5 AND Quality_Rank=$rating AND Value_Rank=$rating AND Supply_Rank=$rating AND $sub_query_7 ORDER BY A.Junior_Area,QVIS_Rank DESC,Supplier_Name;";
				 
		if ($QVIS!="All" AND $rating=="All")
			$query="SELECT DISTINCT $req_columns FROM View_Rank_QVIS_Junior_Buyer AS A INNER JOIN Suppliers_List AS B ON A.Supplier_Number=B.Supplier_Number AND A.Category_Area=B.Category_Area AND A.Junior_Area=B.Junior_Area WHERE $sub_query_2 AND $sub_query_3 AND $sub_query_4 AND $sub_query_5 AND $sub_query_7 ORDER BY A.Junior_Area,QVIS_Rank DESC,Supplier_Name;";
					
		if ($QVIS!="All" AND $rating!="All")
			$query="SELECT DISTINCT $req_columns FROM View_Rank_QVIS_Junior_Buyer AS A INNER JOIN Suppliers_List AS B ON A.Supplier_Number=B.Supplier_Number AND A.Category_Area=B.Category_Area AND A.Junior_Area=B.Junior_Area WHERE $sub_query_2 AND $sub_query_3 AND $sub_query_4 AND $sub_query_5 AND $QVIS=$rating AND $sub_query_7 ORDER BY A.Junior_Area,QVIS_Rank DESC,Supplier_Name;";
