...
Case when LY_Tw_Score=0 then round((LY_Tw_Score-TY_Tw_Score),1) else round((TY_Tw_Score-LY_Tw_Score),1)
  end as YOY_Week,
Case when LY_QTD_Score=0 then round((LY_QTD_Score-TY_QTD_Score),1) else round((TY_QTD_Score-LY_QTD_Score),1)
  end  as YOY_QTD,
Case when LY_YTD_Score=0 then round((LY_YTD_Score-TY_YTD_Score),1) else round((TY_YTD_Score-LY_YTD_Score),1)
  end as YOY_YTD,
