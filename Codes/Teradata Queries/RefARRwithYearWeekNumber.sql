...
(
SELECT
wks.year_week_number as Year_Week_Number,
...
count(distinct(avgC.LONG_DESCRIPTION)) as LG_Count
from
...
on avgg.Product_Sub_Group_Code=ARR.Product_Sub_Group_Code
