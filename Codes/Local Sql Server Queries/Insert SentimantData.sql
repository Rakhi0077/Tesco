...
Insert into  tblSentimentData
select * from(
select
Brand as Channel,
Week_No,
case when Measures in ('Aisles Staff Friendly','Staff Proactively Helped','Aisles Staff Helpful') then 'Colleagues are Helpful'
	  when Measures in ('Product Range','Satisfied with Stock') then 'I Can Get What I Want'
	  ...
	  when Brand='Online (GHS)' and Measures in ('NPS_Score') then 'Overall'
	  when Brand='Online (GHS)' and Measures in ('Delivery_On_Time_Score','Delivery_Driver_Helpfulness_Score') then 'Colleagues are Helpful'
	  when Brand='Online (GHS)' and Measures in ('NPS_Score') then 'Overall'
	  when Brand='Online (GHS)' and Measures in ('NPS_Score') then 'Overall'
	  when Brand='Online (GHS)' and Measures in ('Availability_Score','Fresh_Food_quality_Score','Price_Satisfaction_Score','Product_Quality_Score','Range_satisfaction_Score')then 'I Can Get What I Want'
