...
case when x.TPNB = loc.TPNB then 'Local' when x.TPNB = com.TPNB then 'Commodities' when x.TPNB = nit.TPNB then 'N.I_Local' when cat.Category_Director = 'BAKERY&DAIR   Y.' then cat.Buying_Controller else cat.Category_Director end as Category,
case 
...
where Calendar_Date = dateadd(day, -7, convert(date, getdate())))
  ...
  case when x.TPNB = loc.TPNB then 'Local' when x.TPNB = com.TPNB then 'Commodities'   when x.TPNB = nit.TPNB then 'N.I_Local' when cat.Category_Director = 'BAKERY&DAIR   Y.' then cat.Buying_Controller else cat.Category_Director end,
  case 
when cat.Product_Sub_Group_Code in ('T11AG','T11AH','T11CB','T11CE','T11CG','T11CH','T11CK','T11EB','T11EE','T11EG',
'T11EH','T11GB','T11GE','T11GG','T11GH','T11WA') then 'Filter Cigarettes'
when cat.Product_Sub_Group_Code in ('T13AA','T13AB','T13AC','T13AF','T13AD') then 'Cigars'
...
when cat.Product_Sub_Group_Code in ('L11AA') then 'Kiosk'
  ...
  case when s.TPNB = loc.TPNB then 'Local' when s.TPNB = com.TPNB then 'Commodities'  when s.TPNB = nit.TPNB then 'N.I_Local' when cat.Category_Director = 'BAKERY&DAIR   Y.' then cat.Buying_Controller else cat.Category_Director end as Category,
    case 
when cat.Product_Sub_Group_Code in ('T11AG','T11AH','T11CB','T11CE','T11CG','T11CH','T11CK','T11EB','T11EE','T11EG',
'T11EH','T11GB','T11GE','T11GG','T11GH','T11WA') then 'Filter Cigarettes'
when cat.Product_Sub_Group_Code in ('T13AA','T13AB','T13AC','T13AF','T13AD') then 'Cigars'
...
where Calendar_Date = dateadd(day, -7, convert(date, getdate())))
  ...
  case when s.TPNB = loc.TPNB then 'Local' when s.TPNB = com.TPNB then 'Commodities'  when s.TPNB = nit.TPNB then 'N.I_Local' when cat.Category_Director = 'BAKERY&DAIR   Y.' then cat.Buying_Controller else cat.Category_Director end,
    case 
when cat.Product_Sub_Group_Code in ('T11AG','T11AH','T11CB','T11CE','T11CG','T11CH','T11CK','T11EB','T11EE','T11EG',
'T11EH','T11GB','T11GE','T11GG','T11GH','T11WA') then 'Filter Cigarettes'
when cat.Product_Sub_Group_Code in ('T13AA','T13AB','T13AC','T13AF','T13AD') then 'Cigars'
